...
import { CustomModal } from "src/components/AdminComponents/commons";
import { DataTable } from "src/components/AdminComponents/commons";
...
function LessonAdmin(props) {
  ...
  return (
    <>
      ...
      <DataTable
        title="Lessons"
        labelBtnCreate="Add Lesson"
        columns={columns}
        enableBtnCreate={true}
        onClickBtnCreate={createLesson}
