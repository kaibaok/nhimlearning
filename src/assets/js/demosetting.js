...
function _unsupportedIterableToArray(e, t) {
  ...
  if (e)
    return "string" == typeof e
      ...
      : "Map" ===
          (o =
            "Object" === (o = Object.prototype.toString.call(e).slice(8, -1)) &&
            e.constructor
              ? e.constructor.name
              : o) || "Set" === o
      ? Array.from(e)
...
!(function (e) {
  ...
  "function" == typeof define && define.amd && (define(e), (t = !0)),
    ...
    t ||
      ((o = window.Cookies),
      ((r = window.Cookies = e()).noConflict = function () {
  ...
  return (function e(d) {
    ...
    function o(e, t, o) {
      if ("undefined" != typeof document) {
        "number" == typeof (o = s({ path: "/" }, i.defaults, o)).expires &&
  ...
  (function (i, s) {
    ...
    (i.Demo = {
      ...
      apps: function (e) {
        var t,
          o,
          r = window.location.pathname.split("/").map(function (e, t, o) {
            return e.replace("-", "");
          }),
      ...
      apply: function () {
        i.Demo.apps();
        var e,
          t = _createForOfIteratorHelper(n);
        try {
          for (t.s(); !(e = t.n()).done; ) {
            var o,
              r,
            ...
            ("aside" !== a && "header" !== a && "style" !== a) ||
              ((o = i.Demo.defs(a)),
              s((r = "aside" === a ? c : "header" === a ? f : d)).removeClass(
                i.Demo.style("all", a)
              ),
              "ui-default" !== o && "is-default" !== o && s(r).addClass(o)),
      ...
      update: function (e, t, o) {
        ...
        i.Demo.apps();
        ("aside" !== e && "header" !== e) ||
          (s((r = "header" == e ? f : c)).removeClass(n), s(r).addClass(a)),
          "mode" === e &&
            (d.removeClass(n).removeAttr("theme"),
            a === p
              ? (d.addClass(a).attr("theme", "dark"), i.Demo.locked(!0))
              : (d.addClass(a).removeAttr("theme"), i.Demo.locked(!1))),
          "style" === e && (d.removeClass(n), d.addClass(a)),
          "skin" === e &&
            ((r = i.Demo.skins(a)),
            (n = s("#skin-default")
              .attr("href")
              .replace("theme", "skins/" + r)),
            "theme" === r
              ? s(u).remove()
              : 0 < s(u).length
              ? s(u).attr("href", n)
      ...
      reset: function () {
        var e,
          ...
          o =
            ...
            _createForOfIteratorHelper(n));
        try {
          for (o.s(); !(e = o.n()).done; ) {
            var r = e.value;
            s("[data-key='" + r + "']").each(function () {
              var e = s(this).data("update");
              ("aside" !== r && "header" !== r && "style" !== r) ||
                (e === v[t][r] && s(this).addClass("active")),
                ("mode" !== r && "skin" !== r) ||
                  (e !== a && "default" !== e) ||
        ...
        s("[data-key='dir']").each(function () {
          s(this).data("update") === i.Demo.current("dir") &&
            s(this).addClass("active");
        }),
          i.Demo.apply();
      },
          ...
          0 < s(y).length &&
            s(y).each(function () {
              ...
              ("aside" !== t && "header" !== t && "style" !== t) ||
                (e === i.Demo.defs(t) &&
                  (s(this).parent(h).find(y).removeClass("active"),
                  s(this).addClass("active"))),
                ("mode" !== t && "skin" !== t && "dir" !== t) ||
                  (e != i.Demo.current("skin") &&
                    e != i.Demo.current("mode") &&
                    e != i.Demo.current("dir")) ||
                  (s(this).parent(h).find(y).removeClass("active"),
                  s(this).addClass("active"));
            });
      },
