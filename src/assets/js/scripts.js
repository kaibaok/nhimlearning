  ...
  (p.ClassBody = function () {
    ...
    (p.Toast = function (t, e, n) {
      ...
      (n.position = n.position ? "toast-" + n.position : "toast-bottom-right"),
        ...
        "" !==
          (t =
            "" !== t ? i + '<div class="toastr-text">' + t + "</div>" : "") &&
    ...
    (p.TGL.content = function (t, e) {
      ...
      p.TGL.screen(n),
        t.on("click", function (t) {
          (o = this),
            p.Toggle.trigger(u(this).data("target"), s),
            t.preventDefault();
        }),
        c.on("mouseup", function (t) {
          ...
          o &&
            ...
            e.is(t.target) ||
              ...
              (p.Toggle.removed(e.data("target"), s), (o = !1)));
        }),
        r.on("resize", function () {
          n.each(function () {
            var t = u(this).data("content"),
              ...
              e = d[e];
            p.Win.width > e && p.Toggle.removed(t, s);
          });
        });
    }),
    ...
    (p.TGL.ddmenu = function (t, e) {
      var t = t || ".nk-menu-toggle",
        ...
        a = e ? f(n, e) : n;
      u(t).on("click", function (t) {
        (p.Win.width < d.lg || u(this).parents().hasClass(l)) &&
          p.Toggle.dropMenu(u(this), a),
          t.preventDefault();
      });
    }),
      ...
      n.on("click", function (t) {
        ...
        c.on("mouseup", function (t) {
          !n.is(t.target) &&
            ...
            0 === a.has(t.target).length &&
            p.Win.width < i &&
            p.Toggle.removed(n.data("target"), o);
        }),
        r.on("resize", function () {
          (p.Win.width < d.xl || p.Win.width < i) &&
            p.Toggle.removed(n.data("target"), o);
        });
    }),
    (p.sbCompact = function () {
      ...
      t.on("click", function (t) {
        ...
        var t = u(this),
          e = t.data("target"),
          e = u("[data-content=" + e + "]");
        t.toggleClass("compact-active"), e.toggleClass("is-compact");
      });
    }),
      ...
      u(t).exists() &&
        u(t).each(function () {
          var t = u(this).data("auto-responsive"),
            ...
            n = u(this).data("export-title")
              ? u(this).data("export-title")
              : "Export",
            a = e
    ...
    (p.BS.tabfix = function (t) {
      u(t || '[data-toggle="modal"]').on("click", function () {
        ...
        t && "#" !== t && e
          ? e.find('[href="' + t + '"]').tab("show")
          : e &&
            ((n = e.find(".nk-nav.nav-tabs")),
    ...
    (p.Tagify = function (t, e) {
      u(t).exists() &&
        "function" == typeof u.fn.tagify &&
        ((e = e ? f(void 0, e) : void 0), u(t).tagify(e));
    }),
